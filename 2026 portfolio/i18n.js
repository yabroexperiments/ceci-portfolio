...
window.I18N_DICT = {
  ...
  /* ---------- 其他 Misc ---------- */
  'card.wallet.title': { en: "Social Trading Leaderboard Design", zh: "合約交易排行榜設計" },
  'card.wallet.desc': { en: "Futures Leaderboard displays a ranking of futures’ traders on Binance based on different criteria such as ROI, PnL and popularity within a given time period.", zh: "合約排行榜根據投資回報率、盈虧和受歡迎程度等不同標準，在給定的時間段內，對幣安合約交易員進行排名。" },
  'card.leader.title': { en: "TraderWagon", zh: "TraderWagon" },
