...
Static rip is a stop-gap. Long-term, Ceci should rebuild on **Framer** (designer-friendly visual editor, $15/mo) or have Codex maintain a custom Astro/Next.js site (free, requires Markdown editing or asking Codex). User chose to stick with static rip "for now" but is aware of the maintainability trade-off.
